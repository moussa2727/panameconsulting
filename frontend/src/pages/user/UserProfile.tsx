...
const UserProfile = () => {
  const { user, token, updateUserProfile, refreshToken } = useAuth();
  ...
  const handleProfileSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Réinitialiser les états de toucher
      setProfileTouched({});
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`block w-full pl-10 pr-3 py-3 border rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500focus:ring-none focus:outline-none hover:border-blue-600 focus:border-blue-500 transition-colors ${
